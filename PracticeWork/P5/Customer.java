...
public class Customer {   
     ...
     *  @param customerName is Name of the customer as a String.
     *  @param address is address of the customer.
     *  @param telephoneNumber is telephone number of the customer.
     */
	...
	public String toString() {
		return "Customer Name: " + customerName + ", Address: " + address + ", Telephone Number: "
				+ telephoneNumber + ".";
	}
